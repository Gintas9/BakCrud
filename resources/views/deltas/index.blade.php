...
@section('content')
    ...
    <div class="container  ">
        ...
        <div class="d-flex justify-content-center">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('deltas.store')}}" onsubmit="return confirm('Do you really want to create the item?');">
                {{csrf_field()}}
                <div class="">
                    ...
                    <div class="main-box clearfix">
                        <div class="table-responsive">
                            <table class="table ">
                                ...
                                <tr>
                                    <th><span>#</span></th>
                                           <th><span>married</span></th>      <th><span>name</span></th>      <th><span>lastName</span></th>
                                ...
                                @foreach($deltas as $delta)
                                    ...
                                    <tr>
                            <td style="text-align: left;">{{$delta->id}}</td>
                                      <td style="text-align: left;">{{$delta->married}}</td><td style="text-align: left;">{{$delta->name}}</td><td style="text-align: left;">{{$delta->lastName}}</td>



                                    <td style="width: 20%;">
                                        <a href="{{route('deltas.show',$delta)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										<i class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
									</span>
                                        </a>
                                        <a href="{{route("deltas.edit",$delta)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										...
										<form onsubmit="return confirm('Do you really want to delete the item?');"
                                                                                  action="{{route('deltas.destroy',$delta)}}" method="POST" class="fa-stack">
                                                            @method('DELETE')
                                                @csrf
