                        ...
                        <div class="table-responsive">
                            <table class="table ">
                                ...
                                @foreach($moderators as $moderator)
                                    ...
                                    <tr>
                            <td style="text-align: left;">{{$moderator->id}}</td>
                                      <td style="text-align: left;">{{$moderator->gender}}</td><td style="text-align: left;">{{$moderator->name}}</td><td style="text-align: left;">{{$moderator->lastName}}</td>



                                    <td style="width: 20%;">
                                        <a href="{{route('moderators.show',$moderator)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										<i class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
									</span>
                                        </a>
                                        <a href="{{route("moderators.edit",$moderator)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										...
										<form onsubmit="return confirm('Do you really want to delete the item?');"
                                                                                  action="{{route('moderators.destroy',$moderator)}}" method="POST" class="fa-stack">
                                                            @method('DELETE')
                                                @csrf
