...
@section('content')
    ...
    <div class="container  ">
        ...
        <div class="d-flex justify-content-center">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('fs.store')}}" onsubmit="return confirm('Do you really want to create the item?');">
                {{csrf_field()}}
                <div class="">
                    ...
                    <div class="main-box clearfix">
                        <div class="table-responsive">
                            ...
                            <td style="text-align: left;">{{$f->id}}</td>
                                    ...
                                    <td style="width: 20%;">
                                        <a href="{{route('fs.show',$f)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										<i class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
									</span>
                                        </a>
                                        <a href="{{route("fs.edit",$f)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										...
										<form onsubmit="return confirm('Do you really want to delete the item?');"
                                                                                  action="{{route('fs.destroy',$f)}}" method="POST" class="fa-stack">
                                                            @method('DELETE')
                                                @csrf
