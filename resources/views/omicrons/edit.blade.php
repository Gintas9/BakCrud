    ...
    <main class="">
        ...
        <div class="container d-flex justify-content-center">
            ...
            <div class=" justify-content-center topics col-lg-5">
                <a href="{{route('omicrons.show',$omicron)}}" class="btn btn-warning">
                    Back
                </a>
                <form enctype="multipart/form-data" method="POST" action="{{route('omicrons.update',['omicron'=>$omicron])}}">
                    @method('PUT') @csrf
                    <br>
                    ...
                    </select>   <div class='input-group input-group-lg'><input name='name' id='name' type='Text' class='form-control' aria-label='Large' aria-describedby='inputGroup-sizing-sm' value='{{$omicron->name}}' placeholder='name'></div>  <div class='input-group input-group-lg'><input name='lastName' id='lastName' type='Text' class='form-control' aria-label='Large' aria-describedby='inputGroup-sizing-sm' value='{{$omicron->lastName}}' placeholder='lastName'></div>
