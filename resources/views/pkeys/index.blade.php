...
@section('content')
    ...
    <div class="container  ">
        ...
        <div class="d-flex justify-content-center">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('pkeys.store')}}" onsubmit="return confirm('Do you really want to create the item?');">
                {{csrf_field()}}
                <div class="">
                        ...
                        <div class="table-responsive">
                            <table class="table ">
                                ...
                                @foreach($pkeys as $pkey)
                                    ...
                                    <tr>
                            <td style="text-align: left;">{{$pkey->id}}</td>
                                      <td style="text-align: left;">{{$pkey->name}}</td>



                                    <td style="width: 20%;">
                                        <a href="{{route('pkeys.show',$pkey)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										<i class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
									</span>
                                        </a>
                                        <a href="{{route("pkeys.edit",$pkey)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										...
										<form onsubmit="return confirm('Do you really want to delete the item?');"
                                                                                  action="{{route('pkeys.destroy',$pkey)}}" method="POST" class="fa-stack">
                                                            @method('DELETE')
                                                @csrf
