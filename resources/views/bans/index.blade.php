...
@section('content')
  ...
  <input name='userID' id='userID' type='Text' class='form-control' aria-label='Large' aria-describedby='inputGroup-sizing-sm' value='' placeholder='userID'></div>
                        ...
                        <div class="table-responsive">
                            <table class="table ">
                                ...
                                @foreach($bans as $ban)
                                    ...
                                    <tr>
                            <td style="text-align: left;">{{$ban->id}}</td>
                                      <td style="text-align: left;">{{$ban->userID}}</td>



                                    <td style="width: 20%;">
                                        <a href="{{route('bans.show',$ban)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										<i class="fa fa-search-plus fa-stack-1x fa-inverse"></i>
									</span>
                                        </a>
                                        <a href="{{route("bans.edit",$ban)}}" class="table-link">
									<span class="fa-stack">
										<i class="fa fa-square fa-stack-2x"></i>
										...
										<form onsubmit="return confirm('Do you really want to delete the item?');"
                                                                                  action="{{route('bans.destroy',$ban)}}" method="POST" class="fa-stack">
                                                            @method('DELETE')
                                                @csrf
