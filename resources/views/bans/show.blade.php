...
@section('content')
    ...
    <div class="container ">
        ...
        <div class="d-flex justify-content-center">
            ...
            <p>Created at: {{$ban->created_at}}</p>

        </div>

        <div class="d-flex justify-content-center list-inline m-2">
            <a href="{{route('bans.index')}}" class="btn btn-warning list-inline-item">
                Back
            </a>

            <a href="{{route("bans.edit",$ban)}}" class="btn btn-primary list-inline-item">Edit</a>
        ...
        <div class="d-flex  justify-content-center">
            <div class="list-group col-lg-4 ">
                ...
                <div href='' class='list-group-item list-group-item-action '>
                    <div>
                        <h3> UserID : {{(string)$ban->userID }}</h3>
                    </div>
                </div>
