    ...
    <main class="">
        ...
        <div class="container d-flex justify-content-center">
            ...
            <div class=" justify-content-center topics col-lg-5">
                <a href="{{route('customers.show',$customer)}}" class="btn btn-warning">
                    Back
                </a>
                <form method="POST" action="{{route('customers.update',['customer'=>$customer])}}">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input name='title' type='text' id='form1Example1' class='form-control' value='{{$customer->title}}'/><input name='body' type='text' id='form1Example1' class='form-control' value='{{$customer->body}}'/>
